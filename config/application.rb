...
module CspaceConverter
  class Application < Rails::Application
    ...
    config.client = CollectionSpace::Client.new(
    ...
    config.refcache = CollectionSpace::RefCache.new(
      config: {
        domain: ENV.fetch('CSPACE_CONVERTER_DOMAIN'),
        error_if_not_found: false,
        lifetime: ENV['RAILS_ENV'] != 'test' ? (60 * 60) * 24 : 1,
