...
RSpec.describe CollectionSpace::Converter::Core::CoreExhibition do
  ...
  let(:xpaths) {[
    ...
    { xpath: '/document/*/workingGroupList/workingGroup[1]/exhibitionPersonGroupList/exhibitionPersonGroup[1]/exhibitionPerson', transform: ->(text) { CSURN.parse(text)[:label] } },
    { xpath: '/document/*/workingGroupList/workingGroup[1]/exhibitionPersonGroupList/exhibitionPersonGroup[1]/exhibitionPerson', transform: ->(text) { CSURN.parse(text)[:subtype] } },
    #{ xpath: '/document/*/workingGroupList/workingGroup[1]/exhibitionPersonGroupList/exhibitionPersonGroup[2]/exhibitionPerson', transform: ->(text) { CSURN.parse(text)[:label] } },
